...
--
-- Name: get_department_by_group_id(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION get_department_by_group_id(integer) RETURNS integer
    LANGUAGE sql
    AS $_$SELECT departments.department_id from departments join groups on departments.department_id = groups.department_id where groups.group_id=$1$_$;


ALTER FUNCTION public.get_department_by_group_id(integer) OWNER TO postgres;
...
--
-- Name: get_group_entering_date_by_id(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION get_group_entering_date_by_id(integer) RETURNS date
    LANGUAGE sql
    AS $_$SELECT groups.group_entering_date from groups where groups.group_id=$1$_$;


ALTER FUNCTION public.get_group_entering_date_by_id(integer) OWNER TO postgres;

--
-- Name: get_group_name(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION get_group_name(integer) RETURNS text
    LANGUAGE c
    AS '/var/lib/pgsql/libdb36.so', 'get_group_name';
...
--
-- Name: get_group_number_by_id(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION get_group_number_by_id(integer) RETURNS integer
    LANGUAGE sql
    AS $_$SELECT groups.group_number from groups where groups.group_id=$1$_$;


ALTER FUNCTION public.get_group_number_by_id(integer) OWNER TO postgres;
